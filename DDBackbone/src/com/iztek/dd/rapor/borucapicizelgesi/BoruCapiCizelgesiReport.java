...
public class BoruCapiCizelgesiReport implements ReportInterface {
	private ProjectController controller = null;
	
	public BoruCapiCizelgesiReport(ProjectController controller){
		this.controller = controller;
	}
		
	public void getReport(String outputPath){
		String xmlFileName = "rpt/BoruCapiCizelgesi";
		boolean flag = true;
		String type = "pdf";
		...
		try {
			...
			if (flag) {
				...
				flag = FillReport.fillReport(xmlFileName, parameters, new BoruCapiCizelgesiDS(controller));
				if (flag) {
