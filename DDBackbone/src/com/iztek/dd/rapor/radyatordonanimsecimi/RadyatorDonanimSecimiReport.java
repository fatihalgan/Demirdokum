...
public class RadyatorDonanimSecimiReport implements ReportInterface {
	private ProjectController controller = null;
	
	public RadyatorDonanimSecimiReport(ProjectController controller){
		this.controller = controller;
	}
		
	public void getReport(String outputPath) throws Exception{
		String xmlFileName = "rpt/RadyatorDonanimSecimi";
		boolean flag = true;
		String type = "pdf";
		...
		try {
			...
			if (flag) {
				...
				flag = FillReport.fillReport(xmlFileName, parameters, new RadyatorDonanimSecimiDS(controller));
				if (flag) {
