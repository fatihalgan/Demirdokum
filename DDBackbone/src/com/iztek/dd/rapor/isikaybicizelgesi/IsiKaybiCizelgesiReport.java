...
public class IsiKaybiCizelgesiReport implements ReportInterface {
	private ProjectController controller = null;
	
	public IsiKaybiCizelgesiReport(ProjectController controller){
		this.controller = controller;
	}
	
	public void getReport(String outputPath) throws Exception{
		String xmlFileName = "rpt/IsiKaybiCizelgesi";
		boolean flag = true;
		String type = "pdf";
		...
		try {
			...
			if (flag) {
				...
				flag = FillReport.fillReport(xmlFileName, parameters, new IsiKaybiCizelgesiDS(controller));
				if (flag) {
