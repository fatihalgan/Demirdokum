...
public class IsiYalitimProjesiReport implements ReportInterface {
	private ProjectController controller = null;
	
	public IsiYalitimProjesiReport(ProjectController controller){
		this.controller = controller;
	}
		
	public void getReport(String outputPath){
		String xmlFileName = "rpt/IsiYalitimProjesi";
		boolean flag = true;
		String type = "pdf";
		...
		try {
			...
			if (flag) {
				...
				flag = FillReport.fillReport(xmlFileName, parameters, new IsiYalitimProjesiDS(controller));
				if (flag) {
