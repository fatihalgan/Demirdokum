...
public class Cizelge2Report implements ReportInterface {
	private ProjectController controller = null;
	
	public Cizelge2Report(ProjectController controller){
		this.controller = controller;
	}
		
	public void getReport(String outputPath){
		String xmlFileName = "rpt/Cizelge2";
		boolean flag = true;
		String type = "pdf";
		...
		try {
			...
			if (flag) {
				...
				flag = FillReport.fillReport(xmlFileName, parameters, new Cizelge2DS(controller));
				if (flag) {
